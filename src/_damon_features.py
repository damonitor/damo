...
features_list = [
        ...
        # v7.2-rc1 reelase: Sun Jun 28 12:01:31 2026 -0700
        DamonFeature(name='sysfs/damos_action_collapse',
                     upstream_status='merged in v7.2-rc1 (58996503b631)',
                     upstreamed_version='7.2'),
        DamonFeature(name='sysfs/damos_quota_goal_node_eligible_mem_bp',
                     upstream_status='merged in v7.2-rc1 (9138e27a3bc3)',
                     upstreamed_version='7.2'),
        DamonFeature(name='sysfs/ctx_pause',
                     upstream_status='merged in v7.2-rc1 (3b9e3cc0405b4)',
                     upstreamed_version='7.2'),
        DamonFeature(name='sysfs/damos_quota_fail_charge_ratio',
                     upstream_status='merged in v7.2-rc1 (c7ec7d5f6b3d1)',
                     upstreamed_version='7.2'),
        ...
        DamonFeature(name='sysfs/probe_type_pgidle_set',
                     upstream_status='hacking on damon/next',
                     upstreamed_version='none'),
        DamonFeature(name='sysfs/avail_prep_actions',
                     upstream_status='hacking on damon/next',
                     upstreamed_version='none'),
        DamonFeature(name='sysfs/avail_probe_filter_types',
                     upstream_status='hacking on damon/next',
                     upstreamed_version='none'),
